...
<div class="max-w-lg mx-auto bg-white/90 shadow-2xl p-8 rounded-2xl animate-fade-in-up mt-10">
    ...
    <form action="{{ route('bookings.store') }}" method="POST" class="space-y-5">
        ...
        <div>
            ...
            <input type="text" name="name" value="{{ Auth::user()->username ?? old('name') }}"
                class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-cyan-400 focus:outline-none" readonly>
        </div>
