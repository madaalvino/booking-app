            ...
            <div class="relative z-10">
                    ...
                    <div class="form-group">
                        <div class="floating-input">
                            <input type="text" name="username" id="username"
                                   class="peer w-full px-4 py-4 pt-6 border-2 border-gray-200 rounded-xl bg-gray-50/50 backdrop-blur-sm transition-all duration-300 focus:border-sky-500 focus:bg-white focus:shadow-lg focus:scale-105 @error('username') border-red-500 animate-shake @enderror"
                                   value="{{ old('username') }}" required placeholder=" ">
                            <label for="username" class="floating-label absolute left-4 top-4 text-gray-500 transition-all duration-300 peer-focus:top-2 peer-focus:text-xs peer-focus:text-sky-700 peer-focus:font-semibold peer-[:not(:placeholder-shown)]:top-2 peer-[:not(:placeholder-shown)]:text-xs peer-[:not(:placeholder-shown)]:text-sky-700 peer-[:not(:placeholder-shown)]:font-semibold">
                                Username
                            </label>
                    ...
                    <div class="form-group">
                        <div class="floating-input">
                            <input type="text" name="tlp" id="tlp"
                                   class="peer w-full px-4 py-4 pt-6 border-2 border-gray-200 rounded-xl bg-gray-50/50 backdrop-blur-sm transition-all duration-300 focus:border-sky-500 focus:bg-white focus:shadow-lg focus:scale-105"
                                   value="{{ old('tlp') }}" placeholder=" ">
                            <label for="tlp" class="floating-label absolute left-4 top-4 text-gray-500 transition-all duration-300 peer-focus:top-2 peer-focus:text-xs peer-focus:text-sky-700 peer-focus:font-semibold peer-[:not(:placeholder-shown)]:top-2 peer-[:not(:placeholder-shown)]:text-xs peer-[:not(:placeholder-shown)]:text-sky-700 peer-[:not(:placeholder-shown)]:font-semibold">
                                Phone (Optional)
                            </label>
                            <div class="input-glow absolute inset-0 rounded-xl bg-gradient-to-r from-sky-500 to-cyan-500 opacity-0 transition-opacity duration-300 peer-focus:opacity-20 -z-10"></div>
                        </div>
                ...
                <div class="mt-8 text-center">
                    <p class="text-gray-600 font-medium">
                        Sudah punya akun?
                        <a href="{{ route('login') }}" class="register-link text-transparent bg-gradient-to-r from-sky-700 to-cyan-600 bg-clip-text font-bold hover:from-indigo-900 hover:to-sky-600 transition-all duration-300 relative group">
                            Login
